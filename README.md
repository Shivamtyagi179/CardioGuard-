...
CardioGuard analyzes the following user inputs:
...
System processes inputs using a risk evaluation model

Generates a heart risk percentage

Based on risk level:

High Risk

Triggers alert (beep sound)
...
CardioGuard is not a medical diagnostic tool.

It is intended for informational and preventive purposes only.
...
This project was built with the goal of addressing a critical issue:
